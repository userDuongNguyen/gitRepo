...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9a0e0bec-870e-4939-bce3-c674b98f8d76' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2f3f3b8a-4da8-4a4d-a535-1f0b1aa0321e');
      cy.get(`[data-cy="name"]`).should('have.value', '2f3f3b8a-4da8-4a4d-a535-1f0b1aa0321e');
